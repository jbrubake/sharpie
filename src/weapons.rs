...
impl Battery { // {{{1
    ...
    fn armor_face_wgt(&self) -> f64 {
        ...
        // TODO: Combine this logic into a single table
        wgt * self.kind.armor_face_wgt() * self.kind.armor_face_wgt_if_no_back()
    }
    ...
    ///
    fn armor_barb_wgt(&self, hull: Hull) -> f64 {
        let mut guns = 0;
        let mut mounts = 0;
        for g in self.groups.iter() {
